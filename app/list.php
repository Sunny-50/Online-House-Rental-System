...
<?php include '../include/header.php';?>
	...
	<!-- Header nav -->	
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background-color:#66A092;" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="../index.php">Sunny</a>
					...
					foreach ($data as $key => $value) {						
						echo '<div class="card card-inverse card-info mb-3" style="padding:1%;">					
								  <div class="card-block">';
								  	echo '<a class="btn btn-warning float-right m-3" href="update.php?id='.$value['id'].'&act=';if(!empty($value['own'])){ echo "ap"; }else{ echo "indi"; } echo '">Edit</a>';
									echo '<a class="btn btn-danger float-right m-3"  href="delete.php?id='.$value['id'].'">Delete</a>';
									 echo 	'<div class="row">
											<div class="col-4">
